...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('feedbax_testsystem', (
            ...
            ('feedbax_site', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('report_email', self.gf('django.db.models.fields.EmailField')(max_length=32)),
    ...
    models = {
        ...
        'feedbax.testsystem': {
            ...
            'created_on': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'feedbax_site': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
            'report_email': ('django.db.models.fields.EmailField', [], {'max_length': '32'}),
